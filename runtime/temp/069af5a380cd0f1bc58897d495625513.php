<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"U:\phpStudy_A\WWW/search/index\view\index\publication.html";i:1485070644;s:54:"U:\phpStudy_A\WWW/search/index\view\public\header.html";i:1479391973;s:55:"U:\phpStudy_A\WWW/search/index\view\Public\sidebar.html";i:1481645998;s:54:"U:\phpStudy_A\WWW/search/index\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<header class="am-topbar am-topbar-inverse am-topbar-fixed-top">
	...
	<div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse-4">
		<ul class="am-nav am-nav-pills am-topbar-nav">
			...
			<li><a href="<?php echo Url('index/publication'); ?>?type=J">期刊文献</a></li>
			<li><a href="<?php echo Url('index/publication'); ?>?type=C">会议文献</a></li>
			<li><a href="<?php echo Url('index/publication'); ?>?type=R">科技报告</a></li>
			<li><a href="<?php echo Url('index/publication'); ?>?type=D">学位论文</a></li>
			<li class="am-dropdown" data-am-dropdown>
				<a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">其他分类 <span class="am-icon-caret-down"></span></a>
				<ul class="am-dropdown-content">
					<li><a href="<?php echo Url('index/publication'); ?>?type=G">汇编文献</a></li>
					<li><a href="<?php echo Url('index/publication'); ?>?type=S">技术标准</a></li>
					<li><a href="<?php echo Url('index/publication'); ?>?type=P">专利文献</a></li>
					<li><a href="<?php echo Url('index/publication'); ?>?type=M">专著文献</a></li>
					<li><a href="<?php echo Url('index/publication'); ?>?type=K">参考工具</a></li>
				</ul>
			</li>
			<li class="am-dropdown" data-am-dropdown>
