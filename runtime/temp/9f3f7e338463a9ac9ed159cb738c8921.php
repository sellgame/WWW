<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"U:\phpStudy_A\WWW/search/usercenter\view\index\special_add.html";i:1488250538;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\public\header.html";i:1488156801;s:61:"U:\phpStudy_A\WWW/search/usercenter\view\Public\usidebar.html";i:1488156814;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\Public\footer.html";i:1488156794;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<script src="<?php echo \think\Config::get('js_path'); ?>amazeui.min.js"></script>
    ...
    function postdata() {
        ...
        $.post('<?php echo Url('special/sadd'); ?>', {
                uid: $('#uid').val(),
                stitle: $('#stitle').val(),
                snote: $('#snote').val(),
                share: share
