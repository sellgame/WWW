<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"U:\phpStudy_A\WWW/search/index\view\index\gofind.html";i:1485073864;s:54:"U:\phpStudy_A\WWW/search/index\view\public\header.html";i:1479391973;s:55:"U:\phpStudy_A\WWW/search/index\view\Public\sidebar.html";i:1485073351;s:54:"U:\phpStudy_A\WWW/search/index\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="am-g" style="margin: 20px 0;">
    <form class="am-form-inline" role="form">
		...
		<div class="am-form-group">
			<input type="text" class="am-form-field am-form-success" style="width:400px" id="keys" value="<?php echo $keys; ?>" placeholder="请输入关键词">
    ...
    <dl class="am-accordion-item">
        ...
        <dd class="am-accordion-bd am-collapse ">
            <div class="am-accordion-content">
                ...
                <a href="<?php echo Url('Index/article'); ?>?aid={{docid}}" target="_blank">[查看文档详细信息]</a> <br/>
            </div>
        </dd>
    </dl>
    {{/each}}
...
function searchs(cpage){
	$.AMUI.progress.start();
	$.post("<?php echo Url('index/search/index'); ?>",{
		keys: $('#okeys').val(),
		year: $('#year').val(),
		cpage: cpage
