<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"G:\phpStudy_A\WWW/search/usercenter\view\index\special.html";i:1488166031;s:59:"G:\phpStudy_A\WWW/search/usercenter\view\public\header.html";i:1488156801;s:61:"G:\phpStudy_A\WWW/search/usercenter\view\Public\usidebar.html";i:1488156814;s:59:"G:\phpStudy_A\WWW/search/usercenter\view\Public\footer.html";i:1488156794;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    ...
    <script id="template01" type="text/x-handlebars-template">
        ...
        <tr>
            ...
            <td class="am-text-center" width="200px">
                <a href="<?php echo Url('special_edit'); ?>?id={{id}}">编辑</a>
                <a href="javascript:void(0);" onclick="sdel({{id}});return false;">删除</a>
                <a href="<?php echo Url('special_param'); ?>?id={{id}}">属性</a>
            </td>
...
<script src="<?php echo \think\Config::get('js_path'); ?>amazeui.min.js"></script>
    ...
    function del() {
        $.post('<?php echo Url('special/sdel'); ?>', {
                uid: <?php echo $uid; ?>,
                sid: $('#csid').val()
            },
