<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"U:\phpStudy_A\WWW/search/usercenter\view\index\index.html";i:1488166053;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\public\header.html";i:1488156801;s:61:"U:\phpStudy_A\WWW/search/usercenter\view\Public\usidebar.html";i:1488156814;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\Public\footer.html";i:1488156794;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<body>
    ...
    <script id="template02" type="text/x-handlebars-template">
        {{#each this}}
        <a href="javascript:void(0);" onclick="">{{mtitle}}</a>
        <br /> {{/each}}
    </script>
...
<script src="<?php echo \think\Config::get('js_path'); ?>amazeui.min.js"></script>
    ...
    $(document).ready(function() {
        $.post('<?php echo Url('statis/downs'); ?>', {
                uid: <?php echo $uid; ?>,
                type: 'day'
            },
        ...
        $.post('<?php echo Url('statis/kvist'); ?>', {
                uid: <?php echo $uid; ?>
            },
            function(data, status) {
                var myTemplate01 = Handlebars.compile($('#template01').html());
                $('#kvist').html(myTemplate01(data));
            });
        $.post('<?php echo Url('statis/avist'); ?>', {
                uid: <?php echo $uid; ?>
            },
            function(data, status) {
                var myTemplate02 = Handlebars.compile($('#template02').html());
                $('#avist').html(myTemplate02(data));
            });
    });
    //-->
    </script>
