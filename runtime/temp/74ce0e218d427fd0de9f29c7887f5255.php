<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"U:\phpStudy_A\WWW/search/index\view\index\publications.html";i:1485070644;s:54:"U:\phpStudy_A\WWW/search/index\view\public\header.html";i:1479391973;s:55:"U:\phpStudy_A\WWW/search/index\view\Public\sidebar.html";i:1485073068;s:54:"U:\phpStudy_A\WWW/search/index\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<header class="am-topbar am-topbar-inverse am-topbar-fixed-top">
	...
	<div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse-4">
		<ul class="am-nav am-nav-pills am-topbar-nav">
			...
			<li><a href="<?php echo Url('index/publications'); ?>?type=J">期刊文献</a></li>
			<li><a href="<?php echo Url('index/publications'); ?>?type=C">会议文献</a></li>
			<li><a href="<?php echo Url('index/publications'); ?>?type=R">科技报告</a></li>
			<li><a href="<?php echo Url('index/publications'); ?>?type=D">学位论文</a></li>
			<li class="am-dropdown" data-am-dropdown>
				<a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">其他分类 <span class="am-icon-caret-down"></span></a>
				<ul class="am-dropdown-content">
					<li><a href="<?php echo Url('index/publications'); ?>?type=G">汇编文献</a></li>
					<li><a href="<?php echo Url('index/publications'); ?>?type=S">技术标准</a></li>
					<li><a href="<?php echo Url('index/publications'); ?>?type=P">专利文献</a></li>
					<li><a href="<?php echo Url('index/publications'); ?>?type=M">专著文献</a></li>
					<li><a href="<?php echo Url('index/publications'); ?>?type=K">参考工具</a></li>
				</ul>
			</li>
			<li class="am-dropdown" data-am-dropdown>
	...
	<dl class="am-accordion-item">
		...
		<dd class="am-accordion-bd am-collapse ">
			<div class="am-accordion-content">
				馆藏单位：{{collectiontunit}} <br/>
				标准书号(ISBN)：{{isbn}} <br/>
				国际标准连续出版物号(ISSN)：{{issn}} <br/>
				刊名识别代码(CODEN码)：{{coden}} <br/>
				国内统一连续出版物号(CN号)：{{cnnumber}} <br/>
				出版单位名称：{{pubunit}} <br/>
				出版单位通信地址：{{pubaddress}} <br/>
				会议地址：{{confaddress}} <br/>
				会议时间：{{confdate}} <br/>
				母体文献责任者：{{sourceresponsible}} <br/>
				<a href="<?php echo Url('Index/plist'); ?>?sid={{s_id}}" target="_blank">[查看相关文档]</a> <br/>
			</div>
		</dd>
	</dl>
    {{/each}}
