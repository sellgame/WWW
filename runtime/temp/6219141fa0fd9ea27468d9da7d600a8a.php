<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"U:\phpStudy_A\WWW/search/admin\view\login\uin.html";i:1486952871;s:54:"U:\phpStudy_A\WWW/search/admin\view\public\header.html";i:1479391973;s:55:"U:\phpStudy_A\WWW/search/admin\view\Public\sidebar.html";i:1485133091;s:54:"U:\phpStudy_A\WWW/search/admin\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
		...
		<form method="post" action="" class="am-form">
			<fieldset>
				...
				<div class="am-form-group">
					...
					<input type="text" name="uname" placeholder="输入登陆账号" required/>
				</div>

				<div class="am-form-group">
					<label for="doc-ipt-pwd-1">登录密码</label>
					<input type="password" name="pass" placeholder="输入登录密码" required/>
				</div>
