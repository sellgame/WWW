<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"U:\phpStudy_A\WWW/search/admin\view\index\publist.html";i:1486977875;s:54:"U:\phpStudy_A\WWW/search/admin\view\public\header.html";i:1479391973;s:56:"U:\phpStudy_A\WWW/search/admin\view\Public\usidebar.html";i:1486971647;s:54:"U:\phpStudy_A\WWW/search/admin\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<script id="template01" type="text/x-handlebars-template">
    ...
    <tr>
	    <td>
	    	<a class="am-fl" href="javascript:void(0);" onclick="">{{sourcename}}</a> 
	    </td>
	    <td class="am-text-center" width="150px">
	    	<a href="javascript:void(0);" onclick="edit({{s_id}})">编辑</a>
	    	<a href="javascript:void(0);" onclick="delete({{s_id}})">删除</a>
	    	<a href="javascript:void(0);" onclick="update({{s_id}})">更新</a>
	    </td>
    </tr>
    {{/each}}
</script>
...
function postdata(cpage){
	$.AMUI.progress.start();
	$.post('<?php echo Url('manage/plist'); ?>',{
		uid: '',
		cpage: cpage
