<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"U:\phpStudy_A\WWW/search/usercenter\view\login\reg.html";i:1481645697;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\public\header.html";i:1479391973;s:60:"U:\phpStudy_A\WWW/search/usercenter\view\Public\sidebar.html";i:1485133091;s:59:"U:\phpStudy_A\WWW/search/usercenter\view\Public\footer.html";i:1479392056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
#searchlist { position:absolute; display:none; Margin-top:1px; padding:0px;}
</style>
</head>
		...
		<form method="post" action="" class="am-form">
			<fieldset>
				...
				<div class="am-form-group">
					<label for="doc-ipt-email-1">登录账号</label> <span class="am-kai">(常用邮箱地址)</span>
					<input type="email" name="uname" id="doc-ipt-email-1" placeholder="输入电子邮件" required/>
				</div>

				<div class="am-form-group">
					<label for="doc-ipt-pwd-1">登录密码</label>
					<input type="password" name="pass" id="doc-ipt-pwd-1" placeholder="输入登录密码" required/>
				</div>
				
				<div class="am-form-group">
					<label for="doc-ipt-pwd-2">重复密码</label>
					<input type="password" name="repass" id="doc-ipt-pwd-2" placeholder="再次输入密码" required/>
				</div>
