<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"U:\phpStudy_A\WWW/search/index\view\index\search.html";i:1488158028;s:54:"U:\phpStudy_A\WWW/search/index\view\public\header.html";i:1488156917;s:55:"U:\phpStudy_A\WWW/search/index\view\Public\sidebar.html";i:1488156923;s:54:"U:\phpStudy_A\WWW/search/index\view\Public\footer.html";i:1488156911;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<script src="<?php echo \think\Config::get('js_path'); ?>amazeui.min.js"></script>
    ...
    function searchs(cpage) {
        $.AMUI.progress.start();
        $.post("<?php echo Url('search/index'); ?>", {
            keys: $('#okeys').val(),
            year: $('#year').val(),
            cpage: cpage
